  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-300 to-pink-300 flex flex-col items-center justify-center text-center p-4">
      ...
      <div className="max-w-2xl bg-white p-8 rounded-2xl shadow-lg">
        ...
        <button className="mt-6 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-xl text-lg shadow-md">
          Try it Meow!
        </button>
      </div>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-gray-800">
        ...
        <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-md">
          ...
          <p className="text-gray-600 text-center mt-2">Tested and approved by real cats!</p>
        </div>
      </div>

      {/* Footer */}
      <footer className="mt-12 text-gray-700 text-sm">
