...
export default function CatKeyboardLanding() {
  ...
  <div className="max-w-2xl bg-white p-8 rounded-2xl shadow-lg mb-12 hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out">
    ...
    <button className="mt-6 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-xl text-lg shadow-md mb-6 hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out">
      Try it Meow!
    </button>
  </div>
